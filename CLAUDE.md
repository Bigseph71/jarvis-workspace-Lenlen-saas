...
Ce workspace est le Jarvis personnel de Joseph Hugues. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Joseph Hugues et je vis à Heidelberg, en Allemagne. Je suis consultant IT indépendant spécialisé en qualité logicielle et gestion de projet agile (ingénieur télécom de formation, certifié PRINCE2 et Scrum), avec une dimension entrepreneuriale. Historiquement au service de grands groupes comme Software Test Manager et IT Project Manager, je me repositionne en parallèle sur l'IA (AI Voice Agents et optimisation des coûts) à destination des PME.

Mes objectifs prioritaires actuels : signer mes 3 premiers clients IA sous 45 jours, décrocher une mission freelance (Software Test Manager ou IT Project Manager) et construire mon tunnel de prospection.

À long terme, bâtir une activité de conseil et de réalisation IA récurrente qui me génère un revenu confortable et de la liberté, avec un portefeuille de PME fidèles et quelques grands comptes en complément.

Le domaine où j'ai besoin du plus d'aide en ce moment : un accompagnement large à 360 degrés, avec en priorité la prospection et l'acquisition client, la stratégie business, la création puis la mise en exploitation de logiciels, et la recherche puis l'implémentation d'idées de business rentables.
